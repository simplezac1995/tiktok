...
layui.config({
    ...
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"/admin/js/cropper/cropper.css\">\n" +
        "<div class=\"layui-fluid showImgEdit\" style=\"display: none;padding: 15px 15px;\">\n" +
        ...
        "        </div>\n" +
        "        <div class=\"layui-form-mid layui-word-aux\">图片的尺寸限定<lable class=\"img-size\">150x150</lable>px</div>\n" +
        "    </div>\n" +
        ...
        "                    <button type=\"button\" class=\"layui-btn\" title=\"移动\" style=\"display:none;\"></button>\n" +
        "                    <button type=\"button\" class=\"layui-btn\" title=\"放大图片\" style=\"display:none;\"></button>\n" +
        "                    <button type=\"button\" class=\"layui-btn\" title=\"缩小图片\" style=\"display:none;\"></button>\n" +
    ...
    var obj = {
        render: function(e){
            ...
            $(elem).on('click',function () {
            	...
            	console.log(saveW,saveH);
            	
            	$(".showImgEdit").remove();
            	$('body').append(html);
            	$('.img-size').text(saveW+"X"+saveH);
